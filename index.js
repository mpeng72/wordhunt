...
/*Trie will check how many words the board contains
This will allow me to reset the board if it is unplayable 
*/
...
/*This will create a 4x4 array of chars and then
create a html table element and assign each char
a table division */

//Creates a 4x4 array of chars that are generated using function generateLetters
...
//generates letters based on the scrabble letter distribution (w/minor edits)
function genLetters() {
    var characters = "AAAAAAABBCCCDDDDEEEEEEEE" +
        "EEEFFGGIIIIIIIIJKLLLLMMNNNNNNOOOOOOOOPPQRR" +
        "RRRRSSSSTTTTTTUUUUVVWWXYZ";
...
/*Create tables to show to current word and
the score/timer*/
...
/*These two functions will append the newly selected
character onto the previous string and check if it forms
a word. If it does, then the currently selected cells
will highlight green to indicate that the word has not yet
been found*/
...
//Function that resets the answerboard if the player
//finds a new word
...
//Function to check which cells are swipable from the current cell
...
/*Function to control the actual elements of gameplay
and another to start the game when a button is clicked*/
//Begins the timer and starts the game
function game() {
    gameIsPlaying = true;
    beginTimer();
